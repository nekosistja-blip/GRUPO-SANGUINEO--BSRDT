...
.donor-line{font-size:1.45rem;font-weight:800;margin-bottom:8px;}
.rh-label{text-align:center;font-size:3.2rem;font-weight:900;margin-top:25px;}
.blood-group{text-align:center;color:#ff0054;font-size:10rem;font-weight:950;line-height:.9;}
</style>
